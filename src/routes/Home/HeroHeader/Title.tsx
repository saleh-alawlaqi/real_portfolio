...
const Title = () => {
    ...
    return (
        <motion.div className="flex flex-col">
            <h1 className="mt-3 text-[32px] text-sky-600 font-inter_black font-semibold leading-[150%] md:text-center md:text-[32px] lg:text-[46px] lg:w-[750px] xl:w-[930px] xl:text-[58px]">
