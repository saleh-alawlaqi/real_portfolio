            ...
            <div className="mt-12 rounded-lg mx-8 lg:mx-12 w-[90%]  lg:max-w-[1300px]">
                ...
                <div className="about_info flex flex-col mt-5">
                    ...
                    <div className="description flex flex-col mt-5">
                        <p>
                            <b>Hello! I'm Chris</b>, a passionate and seasoned UX designer with a
                            keen eye for creating meaningful and delightful user experiences. My
                            journey in the world of design has been a dynamic exploration of
                            blending creativity with functionality, always striving to bridge the
                            gap between user needs and innovative solutions.
                        </p>

                        <p className="mt-5">
                            <b>Design Philosophy</b>: I believe in the power of design to transform
                            digital experiences, making them not only visually appealing but also
                            highly functional and user-centric. My approach is rooted in empathy –
